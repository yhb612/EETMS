...
"td_bg_over"    : "#D1E9E9", //单元格背影色
"tr_word"       : "#FFFFFF", //日历头文字颜色
"tr_bg"         : "#ADADAD", //日历头背影色
"input_border" : "#CCCCCC", //input控件的边框颜色
"input_bg"      : "#C4E1E1"   //input控件的背影色
}
...
mvAry[mvAry.length] = '        <th align="center" width="98%" nowrap="nowrap"><select name="calendarYear" id="calendarYear" style="font-size:12px;background:#6494B6;"></select><select name="calendarMonth" id="calendarMonth" style="font-size:12px;background:#6494B6;"></select></th>';
...
this.panel.style.left = xy.x -225 + "px";
this.panel.style.top = (xy.y + dateObj.offsetHeight-130) + "px";
